  ...
  return (
    <>
        ...
        <div className="flex items-center space-x-10">
          <div className="flex items-center space-x-3 group cursor-pointer">
            ...
            <h1 className="text-2xl font-black tracking-tighter text-white lg:text-3xl">
              MIDNIGHT<span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-pink-400">CINEMA</span>
            </h1>
          </div>
          
          <nav className="hidden items-center space-x-8 md:flex text-xs font-black uppercase tracking-[0.2em] text-gray-500">
            <button className="hover:text-white transition-colors duration-300">English</button>
            <button className="hover:text-white transition-colors duration-300">Hindi</button>
            <button className="hover:text-white transition-colors duration-300">Action</button>
          </nav>
        </div>
      ...
      <aside className="fixed left-6 top-1/2 -translate-y-1/2 z-[60] hidden flex-col items-center space-y-10 rounded-3xl glass p-5 lg:flex border border-white/5">
        ...
        <Icons.Video className="h-7 w-7 text-gray-400 cursor-pointer hover:text-white transition-all" />
        <div className="h-px w-6 bg-white/10" />
